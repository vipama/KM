...
if isEmpty(getSave)  = False then
	if getSave = "Save" then
		...
		if  getradioAuditINOUT  = "1" then
				showSoure_Name = "การตรวจติดตามคุณภาพภายใน"
		elseif getradioAuditINOUT = "2" then
			 	showSoure_Name = "การตรวจติดตามคุณภาพภายนอก"
		end if
		if getcheckComplete = "on" then
				...
				if checkInternalAuditData(GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual),getTypeDepart,(year(Dateddmmyyyy)+543)) = 0 then
						...
						SQL = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_Year,Audit_Flag_Complete,Audit_QMR_P1) values ('C','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSoure_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&(year(Dateddmmyyyy)+543)&"','0','"&gettxtShowQMR&"')"
						'response.write SQL
						ConQS.execute(SQL)
		...
		elseif getcheckComplete = "" then
			if checkInternalAuditData(GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual),getTypeDepart,(year(Dateddmmyyyy)+543)) = 0 then
			   ConQS.BeginTrans
				...
				'response.write getradioAuditINOUT&""
				SQL = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_Year,Audit_Flag_Complete,Audit_QMR_P1) values ('C','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSoure_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&(year(Dateddmmyyyy)+543)&"','1','"&gettxtShowQMR&"')"
				'response.write SQL
				ConQS.execute(SQL)
				sql_log = "insert into Tb_LogInternalAudit (User_Id,Method_Access,Date_Access,Department_Name,M_Code,No_Car_Par,Audit_DocType) values ('"&session("member")&"','Add','"&Datemmddyyyy1&"','"&getDepartmentname(getDepartID)&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"','C')"
				ConQS.execute(sql_log)
			...
			'=================================เริ่มบล๊อค     นี่เป็นบล๊อคถ้ามีการติ๊กที่ปุ่มพบหลักฐานแสดงว่าเกิดข้อบกพร่อง===========================================	
				...
				'----------------------------------------------------------------car 1-----------------------------------------------------------------
					if trim(gettxtCARDescript1) <> "" then
						...
						SQL_CAR1 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar1&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSoure_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript1&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"')"
				 ...
				 '---------------------------------------------------------------car 2------------------------------------------------------------------		
					if trim(gettxtCARDescript2) <> "" then
						...
						SQL_CAR2 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar2&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSoure_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript2&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"')"
				...
				'---------------------------------------------------------------car 3-----------------------------------------------------------------------		
					if trim(gettxtCARDescript3) <> "" then
						...
						SQL_CAR3 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar3&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSoure_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript3&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"')"
				...
				'-------------------------------------------------------------------------------------------------------------------------------------------
				 '---------------------------------------------------------------car 4------------------------------------------------------------------		
					if trim(gettxtCARDescript4) <> "" then
						...
						SQL_CAR4 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar4&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSoure_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript4&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"')"
				...
				'---------------------------------------------------------------car 5------------------------------------------------------------------		
					if trim(gettxtCARDescript5) <> "" then
						...
						SQL_CAR5 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar5&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSoure_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript5&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"')"
			...
			'=================================เริ่มบล๊อค     นี่เป็นบล๊อคถ้ามีการติ๊กที่ปุ่มพบความมีแนวโน้มที่จะเกิดข้อบำพร่อง===========================================	
				if getcheckNotFind = "on" then
					...
					if trim(gettxtPARDescript1) <> "" then
						...
						SQL_PAR1 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar1&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSoure_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript1&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"')"
						
						'response.write "<br> 1 ="&SQL_PAR1
						ConQS.execute(SQL_PAR1)
						ConQS.Execute("insert into  Tb_RunNumPAR (PAR_ID,M_Code) values ('"&(year(Dateddmmyyyy)+543&"-16-"&getNumPar1)&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"')")
				 ...
				 '---------------------------------------------------------------par 2------------------------------------------------------------------		
					if trim(gettxtPARDescript2) <> "" then
						...
						SQL_PAR2 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar2&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSoure_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript2&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"')"
						
						'response.write "<br> 2 ="&SQL_PAR2
						ConQS.execute(SQL_PAR2)
						ConQS.Execute("insert into  Tb_RunNumPAR (PAR_ID,M_Code) values ('"&(year(Dateddmmyyyy)+543&"-16-"&getNumPar2)&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"')")
				...
				'---------------------------------------------------------------par 3-----------------------------------------------------------------------		
					if trim(gettxtPARDescript3) <> "" then
						...
						SQL_PAR3 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar3&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSoure_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript3&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"')"
						
						'response.write "<br> 3 ="&SQL_PAR3
						ConQS.execute(SQL_PAR3)
						ConQS.Execute("insert into  Tb_RunNumPAR (PAR_ID,M_Code) values ('"&(year(Dateddmmyyyy)+543&"-16-"&getNumPar3)&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"')")
				...
				'-------------------------------------------------------------------------------------------------------------------------------------------
				 '---------------------------------------------------------------par 4------------------------------------------------------------------		
					if trim(gettxtPARDescript4) <> "" then
						...
						SQL_PAR4 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar4&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSoure_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript4&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"')"
						
						'response.write "<br> 4 ="&SQL_PAR4
						ConQS.execute(SQL_PAR4)
						ConQS.Execute("insert into  Tb_RunNumPAR (PAR_ID,M_Code) values ('"&(year(Dateddmmyyyy)+543&"-16-"&getNumPar5)&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"')")
				...
				'---------------------------------------------------------------par 5------------------------------------------------------------------		
					if trim(gettxtPARDescript5) <> "" then
						...
						SQL_PAR5 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar5&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSoure_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript5&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"')"
...
<table width="85%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    ...
    <td width="80%" class="style1"><label>
      <input type="radio" name="radioTypeDepart" id="radioTypeDepart1" value="1" <%=chkMain%> onClick="ChangeJobresultGroup('','')" />
    ระดับกรม</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label>
      <input type="radio" name="radioTypeDepart" id="radioTypeDepart2" value="2" <%=chkSubmain%> onClick="ChangeJobresultGroup('','')" />
  ...
  <tr>
    ...
    <td>
   		 <%
			  ...
			  <span id="spSubDepart" style="display:none"><input type="text" name="txtSubDepartElse" id="txtSubDepartElse" readonly  /></span>
			  </td>
  </tr>
  <tr>
    ...
    <%
	  Set   recSOP = Server.CreateObject("ADODB.RECORDSET")
	  	sqlSOP = "select  *  from  Tb_Manual where  D_Id='"&getDid&"' "&FlagMain_Reserve&" order by M_Id  asc"
  ...
  <tr>
    ...
    <td class="style1"><label>
      <input type="radio" name="radioAuditINOUT" id="radioAuditIN" value="1" checked="checked" />
      การตรวจติดตามคุณภาพภายใน</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <label>
      <input type="radio" name="radioAuditINOUT" id="radioAuditOUT" value="2" />
      การตรวจติดตามคุณภาพภายนอก</label>      </td>
  </tr>
  <tr>
