			...
			'=================================เริ่มบล๊อค     นี่เป็นบล๊อคถ้ามีการติ๊กที่ปุ่มพบหลักฐานแสดงว่าเกิดข้อบกพร่อง===========================================	
				...
				'----------------------------------------------------------------car 1-----------------------------------------------------------------
					if trim(gettxtCARDescript1) <> "" then
						...
						SQL_CAR1 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar1&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript1&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				 ...
				 '---------------------------------------------------------------car 2------------------------------------------------------------------		
					if trim(gettxtCARDescript2) <> "" then
						...
						SQL_CAR2 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar2&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript2&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				...
				'---------------------------------------------------------------car 3-----------------------------------------------------------------------		
					if trim(gettxtCARDescript3) <> "" then
						...
						SQL_CAR3 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar3&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript3&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				...
				'-------------------------------------------------------------------------------------------------------------------------------------------
				 '---------------------------------------------------------------car 4------------------------------------------------------------------		
					if trim(gettxtCARDescript4) <> "" then
						...
						SQL_CAR4 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar4&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript4&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				...
				'---------------------------------------------------------------car 5------------------------------------------------------------------		
					if trim(gettxtCARDescript5) <> "" then
						...
						SQL_CAR5 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar5&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript5&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				...
				'---------------------------------------------------------------car 6------------------------------------------------------------------		
					if trim(gettxtCARDescript6) <> "" then
						...
						SQL_CAR6 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar6&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript6&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
						'response.write "<br> 5 ="&SQL_CAR5
				...
				'---------------------------------------------------------------car 8------------------------------------------------------------------		
					if trim(gettxtCARDescript8) <> "" then
						...
						SQL_CAR8 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar8&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript8&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
						'response.write "<br> 5 ="&SQL_CAR5
				...
				'---------------------------------------------------------------car 9------------------------------------------------------------------		
					if trim(gettxtCARDescript9) <> "" then
						...
						SQL_CAR9 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar9&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript9&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
						'response.write "<br> 5 ="&SQL_CAR5
				...
				'---------------------------------------------------------------car 10------------------------------------------------------------------		
					if trim(gettxtCARDescript10) <> "" then
						...
						SQL_CAR10 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('NC','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-16-"&getNumCar10&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtCARDescript10&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
						'response.write "<br> 5 ="&SQL_CAR5
			...
			'=================================เริ่มบล๊อค     นี่เป็นบล๊อคถ้ามีการติ๊กที่ปุ่มพบความมีแนวโน้มที่จะเกิดข้อบำพร่อง===========================================	
				if getcheckNotFind = "on" then
					...
					if trim(gettxtPARDescript1) <> "" then
						...
						SQL_PAR1 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar1&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript1&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				 ...
				 '---------------------------------------------------------------par 2------------------------------------------------------------------		
					if trim(gettxtPARDescript2) <> "" then
						...
						SQL_PAR2 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar2&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript2&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				...
				'---------------------------------------------------------------par 3-----------------------------------------------------------------------		
					if trim(gettxtPARDescript3) <> "" then
						...
						SQL_PAR3 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar3&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript3&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				...
				'-------------------------------------------------------------------------------------------------------------------------------------------
				 '---------------------------------------------------------------par 4------------------------------------------------------------------		
					if trim(gettxtPARDescript4) <> "" then
						...
						SQL_PAR4 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar4&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript4&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				...
				'---------------------------------------------------------------par 5------------------------------------------------------------------		
					if trim(gettxtPARDescript5) <> "" then
						...
						SQL_PAR5 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar5&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript5&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				...
				'---------------------------------------------------------------par 6------------------------------------------------------------------		
					if trim(gettxtPARDescript6) <> "" then
						...
						SQL_PAR6 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar6&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript6&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				...
				'---------------------------------------------------------------par 7------------------------------------------------------------------		
					if trim(gettxtPARDescript7) <> "" then
						...
						SQL_PAR7 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar7&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript7&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				...
				'---------------------------------------------------------------par 8------------------------------------------------------------------		
					if trim(gettxtPARDescript8) <> "" then
						...
						SQL_PAR8 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar8&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript8&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				...
				'---------------------------------------------------------------par 9------------------------------------------------------------------		
					if trim(gettxtPARDescript9) <> "" then
						...
						SQL_PAR9 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar9&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript9&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
				...
				'---------------------------------------------------------------par 10------------------------------------------------------------------		
					if trim(gettxtPARDescript10) <> "" then
						...
						SQL_PAR10 = "insert into Tb_Internalaudit  (Audit_DocType,Audit_Level,No_Car_Par,Audit_Date,Audit_Source,Audit_Source_Details,Audit_Depart,Audit_Subdepart,Audit_SubDepartElseName,M_Code,M_Name,Audit_Defect,Audit_Name1,Audit_Name2,Audit_Name3,Audit_Name4,Audit_Name5,Audit_Name6,Audit_Descript,Audit_Advantages,Audit_Disadvantages,Audit_License_P1,Audit_Year,Audit_QMR_P1,Audit_Refer) values ('OBS','"&getTypeDepart&"','"&year(Dateddmmyyyy)+543&"-17-"&getNumPar10&"','"&Datemmddyyyy&"','"&getradioAuditINOUT&"','"&showSource_Name&"','"&getDepartID&"','"&getSubDepartID&"','"&gettxtSubDepartElse&"','"&GetSingleFieldQS("Tb_Manual","M_Code","where  M_Id="&getManual)&"','"&GetSingleFieldQS("Tb_Manual","M_Name","where  M_Id="&getManual)&"','"&gettxtPARDescript10&"','"&gettxtchif&"','"&gettxtFollower1&"','"&gettxtFollower2&"','"&gettxtFollower3&"','"&gettxtFollower4&"','"&gettxtFollower5&"','"&gettxtDes&"','"&gettxtGoodDes&"','"&gettxtBadDes&"','"&getNameAdd&"','"&(year(Dateddmmyyyy)+543)&"','"&gettxtShowQMR&"','"&year(Dateddmmyyyy)+543&"-15-"&getCountIDInternal&"')"
...
<table width="85%" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr id="subDipart" style="display:<% if getTid = "main" then response.write "none" else response.write "" end if %>">
...
<span id="radio5" style="display:none"><input type="text" name="txtSourceElse5" id="txtSourceElse5" readonly  /></span>      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      อื่นๆ</label>&nbsp;&nbsp;<span id="radio6" style="display:none"><input type="text" name="txtSourceElse6" id="txtSourceElse6" readonly  /></span>      </td>
  </tr>
  <tr>
  ...
  <tr>
    <td>ข้อเสนอแนะ :</td>
    <td valign="middle"><textarea name="txtDes" cols="80" rows="5" class="style1" id="txtDes"></textarea></td>
  </tr>
