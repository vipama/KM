...
'------------------------------------------------------------------end block update----------------------------------------------------------------		
		...
		if isEmpty(gethidCPId) = True then
			SQL = "select * from Tb_Internalaudit where  No_Car_Par='"&getCPId&"'  and Audit_DocType='NC'  "
		else
			SQL = "select * from Tb_Internalaudit where  No_Car_Par='"&gethidCPId&"'  and Audit_DocType='NC'  "
		end if
		'response.write SQL
...
.style2 {font-size: 14px; font-family: THSarabunPSK,Arial, Helvetica, sans-serif; font-weight: bold; }
-->
</style>
...
%>
<form name="frmEdit" enctype="application/x-www-form-urlencoded" method="post" action="EditCAR.asp">
<input type="hidden"  name="hidprint" id="hidprint" value=""/>
<table cellpadding="0" cellspacing="0" border="0" align="center" width="80%">
<tr>
<td width="25%" align="right"><b>เลขที่ใบ CAR :</b></td>
...
&nbsp;&nbsp;<input  type="button" value="ค้นหาเพื่อพิมพ์เอกสาร" name="butSearchPrint" id="butSearchPrint" onClick="goEditCar()"  />
...
<% else %>
<br />
<form name="frmEditPart2" id="frmEditPart2" enctype="application/x-www-form-urlencoded" action="EditCAR.asp" method="post">
...
<table width="100%" border="2" align="center" cellpadding="1" cellspacing="0" bordercolor="#000000">
  ...
  <tr><td colspan="2" bgcolor="#CCCCCC" class="style1"><span style="font-weight: bold">ส่วนที่ 1 : ผลการติดตาม</span></td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            <td class="style1"><b>ตรวจติดตามวันที่ :&nbsp;&nbsp;&nbsp;</b><%=get_Audit_Date%></td>
            </tr>
        </table></td>
      </tr>
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="10%" valign="top" class="style1"><b>ที่มา :</b></td>
            <td width="90%" class="style1" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
          ...
          <tr>
            <td colspan="2" class="style1" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="20%" class="style1" style="font-weight: bold" valign="top">หน่วยงานที่พบ :</td>
                <td width="80%" class="style1" valign="top"><%=getDepartmentname(get_Audit_Depart)%></td>
              </tr>
            </table></td>
            </tr>
        </table></td>
      ...
      <tr><td><table width="100%" border="0" cellspacing="0" cellpadding="3">
        <tr>
          <td width="25%" class="style2" valign="top">ขอบเขตการตรวจ :</td>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            ...
            <td width="80%" class="style1" valign="top"><%=get_Audit_Defect%></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
    <td width="40%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="3" class="style1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;รับทราบผลการตรวจติดตามวันที่.................</td>
            </tr>
          <tr>
            <td width="15%" class="style1">ลงชื่อ</td>
 ...
 <tr><td colspan="2" bgcolor="#CCCCCC" class="style1"><span style="font-weight: bold">ส่วนที่ 2 : การปฏิบัติการ<% if PageName = "CAR" then %>แก้ไข<% else %>ป้องกัน<% end if %></span> </td></tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <td width="50%" class="style1" valign="top"><b>กำหนดวันแล้วเสร็จ : </b>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          ...
          <td width="85%" class="style1">ผู้รับการตรวจต้องดำเนินการวิเคราะห์สาเหตุของปัญหา กำหนดแนวทางแก้ไขและกำหนดวันแล้วเสร็จ ส่งให้ผู้ตรวจติดตามพิจารณา ภายใน 30 วันนับจากวันที่ตรวจติดตาม</td>
        </tr>
      </table></td>
    </tr>
    <tr>
  ...
  <td width="40%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr><td><span style="height:5px"><img src="images/spacer.gif" alt=""  height="5"/></span></td>
    </tr>
  </table></td>
  </tr>
...
<%  if isEmpty(gethidCPId) = True and getchkPrint <> "Print" then %>
<div><input type="button" value="บันทึกส่วนที่ 2" onClick="javascript:{ document.frmEditPart2.submit();}"/>&nbsp;&nbsp;&nbsp;<input type="button" value="กลับหน้าหลัก" name="butCancel" onClick="javascript:{ window.location.href='EditCAR.asp';}" /></div>
<% else%>
