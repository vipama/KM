...
<table width="100%" border="2" align="center" cellpadding="1" cellspacing="0" bordercolor="#000000">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr><td height="15"><table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          ...
          <tr>
            <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                ...
                <td width="59%" align="center"><span class="style1"><b><%=get_Audit_License_P1%></b></span></td>
            ...
            <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                <td width="25%" class="style1"><b>ลงชื่อ QMR</b></td>
                <td width="74%" align="center"><span class="style1"><b><%=get_Audit_QMR_P1%></b></span></td>
                <td width="1%" class="style1">&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="2">
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          ...
          <label>
            <textarea name="txtProblem" cols="150" rows="3" id="txtProblem"></textarea>
          </label>
          <% else  response.write get_Audit_Problem  end if %>
          </td>
        </tr>
      </table></td>
    </tr>
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          ...
          <% if isEmpty(gethidCPId) = True  and getchkPrint <> "Print" then %>
          <label>
            <textarea name="txtIndexway" cols="150" rows="3" id="txtIndexway"></textarea>
          </label>
          <% else response.write get_Audit_Protect  end if%>
          </td>
        </tr>
      </table></td>
    </tr>
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <td width="50%" class="style1" valign="top"><b>กำหนดแล้วเสร็จภายในวันที่ : 
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="2">
            <tr>
              ...
              <td width="59%" align="center">
                <% if isEmpty(gethidCPId) = True  and getchkPrint <> "Print" then %>
                <input name="txtNameEditProtect" type="text" id="txtNameEditProtect" size="50" />
        ...
        <tr>
          ...
          <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="2">
            <tr>
              ...
              <td width="59%" align="center" class="style1">&nbsp;</td>
              <td width="1%" class="style1">&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
  ...
  <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <td width="20%" class="style1">ผลการตรวจติดตาม</td>
          <td width="40%" class="style1"><label>
            <input type="checkbox" name="chkAccept" id="chkAccept" disabled="disabled" />
            ยอมรับ</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <label>
        ...
        <tr>
          <td>&nbsp;</td>
          <td class="style1"><label>
            <input type="checkbox" name="chkNotAccept" id="chkNotAccept" disabled="disabled" />
            ไม่ยอมรับ</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <label>
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <td width="20%">&nbsp;</td>
          <td width="80%" class="style1"><b>เหตุผล</b> &nbsp;</td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="1">
        <tr>
          <td width="50%"><table width="90%" border="0" cellspacing="0" cellpadding="1">
            <tr>
