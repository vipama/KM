...
<table width="100%" border="2" align="center" cellpadding="1" cellspacing="0" bordercolor="#000000">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr><td><table width="100%" border="0" cellspacing="0" cellpadding="3">
        <tr>
          <td width="20%" class="style1"><b>กิจกรรมที่ตรวจ (ชื่อ/รหัสเอกสาร)</b></td>
          <td width="80%" class="style1"><%=get_M_Name&" "&get_M_Code%></td>
        </tr>
      </table></td></tr>
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
          ...
          <tr>
            <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                ...
                <td width="59%" align="center"><span class="style1"><%=get_Audit_License_P1%></span></td>
            ...
            <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                ...
                <td width="74%" align="center"><span class="style1"><%=get_Audit_QMR_P1%></span></td>
                <td width="1%" class="style1">&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
        ...
        <tr>
          <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="2">
            <tr>
              ...
              <td width="59%" align="center" class="style1"><%=get_Audit_Head_Depart%></td>
              <td width="1%" class="style1">&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
          ...
          <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="2">
            <tr>
              ...
              <td width="59%" align="center" class="style1"><%=get_Audit_QMR_P1%></td>
              <td width="1%" class="style1">&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
  ...
  <tr>
  <td> <form name="frmEditPart3" id="frmEditPart3" enctype="application/x-www-form-urlencoded" action="FollowUp.asp" method="post">
  <input type="hidden"  name="hidCPId" id="hidCPId" value="<%=get_No_Car_Par%>"/>
  <input type="hidden" name="hidQMRpart3" id="hidQMRpart3"  value="<%=get_Audit_QMR_P2%>" /><table width="100%" border="0" cellspacing="0" cellpadding="2">
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
        <tr>
        ...
        <tr>
          ...
          <td width="40%"><label>
			...
			if isEmpty(gethidCPId) = False or getchkPrint = "Print" then
			 ...
			 %>  />
            ปิด <% if PageName = "CAR" then %>CAR<% else %>PAR<% end if %> No. :</label>&nbsp;&nbsp;<%=get_No_Car_Par%></td>
          <td width="40%">&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>
          <label>
            <input type="checkbox" name="chkAccept" id="chkNotAccept" value="2" 
			<% 
			if isEmpty(gethidCPId) = False or getchkPrint = "Print" then
				response.write "disabled=""disabled"" "  
			end if  
			if isEmpty(gethidCPId) = False or getchkPrint = "Print" then
				    if get_Audit_Accept = "2" then
					  response.write " checked=""checked"" "
					else
					  response.write ""
					end if
			...
			%>  />
            เปิด <% if PageName = "CAR" then %>CAR<% else %>PAR<% end if %> 
            No. : 
            <input type="text" name="txtNewCARPAR" id="txtNewCARPAR" disabled="disabled" />
            </label></td>
          <td>&nbsp;</td>
        </tr>
      </table></td>
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <td width="20%">&nbsp;</td>
          <td width="80%" valign="middle" class="style1"><b>เหตุผล</b> &nbsp;
            <% if isEmpty(gethidCPId) = True and getchkPrint <> "Print" then %>
            <label>
            <textarea name="txtReason" cols="130" rows="3" id="txtReason"></textarea>
            </label>
            <% else  response.write get_Audit_Reason end if %>
            </td>
        </tr>
      </table></td>
    </tr>
        ...
        <tr>
          <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="1">
            <tr>
              ...
              <td width="65%" class="style1" align="center" ><%=GetSingleField("member","NAME"," where email='"&Session("Member")&"' ")&" "&GetSingleField("member","SURNAME"," where email='"&Session("Member")&"' ")%></td>
              <td width="1%" class="style1">&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
          ...
          <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="1">
            <tr>
              <td width="40%" class="style1"><b>ลงชื่อ QMR</b></td>
              <td width="59%" class="style1" align="center"><%=get_Audit_QMR_P2%></td>
              <td width="1%" class="style1">&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
