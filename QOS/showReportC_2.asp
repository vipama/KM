    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr>
			...
			<td width="70%" class="style2" ><%=getDepartmentname(get_Audit_Depart)%>&nbsp;&nbsp;&nbsp;-- <%=GetSingleFieldQS("Tb_Subdepart","Name_Subdepart","  where Subdepart_Id="&get_Audit_SubDepart)%></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td width="30%" class="style2" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
            ...
            <td width="70%"  class="style1" valign="middle"><table width="65%" border="0" cellspacing="0" cellpadding="5">
              <tr>
                <td width="5%" class="style2">1</td>
                <td width="55%" class="style2"><%=get_Audit_Name1%></td>
                <td width="40%" class="style2">หัวหน้าผู้ตรวจติดตาม</td>
              </tr>
              <tr>
            ...
            <td width="70%" class="style1"><table width="100%" border="0" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <label>
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จึงออกใบ CAR จำนวน  <%=RowCAR%>  ใบ <% if RowCAR > 0 then %>ได้แก่<% end if %><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <%
              ...
              <tr>
                <td class="style2"><label>
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จึงออกใบ PAR จำนวน  <%=RowPAR%>  ใบ  <% if RowPAR > 0 then %>ได้แก่<% end if %><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <%
                  		set recShow = Server.CreateObject("ADODB.RECORDSET")
      ...
      <tr>
        <td><table width="97%" border="0" align="center" cellpadding="5" cellspacing="0">
          <tr>
            <td width="50%"><table width="80%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                <td width="15%" class="style1">ลงชื่อ</td>
                <td width="50%">&nbsp;</td>
                <td width="35%" class="style1">หัวหน้าผู้ตรวจติดตาม</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
            ...
            <td width="50%"><table width="80%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                <td width="15%" class="style1">ลงชื่อ</td>
                <td width="50%">&nbsp;</td>
                <td width="35%" class="style1">ผู้ตรวจติดตาม</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
