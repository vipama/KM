        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr><td  bgcolor="#3ed0fd" >&nbsp;&nbsp;&nbsp;<font size="2" face="Ms Sans Serif" color="#3300ff"><strong>Login</strong></font>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2" face="Ms Sans Serif" color="#3300ff"><strong>ผู้ที่สนใจต้องการเข้าดูเอกสารระบบคุณภาพของ อย. สามารถล๊อกอินได้ที่นี่</strong></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
                  <form name="formlogin" method="post" action="http://elib.fda.moph.go.th/kmfda/default.asp">
				  <input type="hidden" name="login" value="1">
				  <input type="hidden" name="qs_chk" value="QS">
                  <tr>
                    <td bgcolor="#3ed0fd" ><font size="2" face="Ms Sans Serif" color="#3300ff">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;E-Mail&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<input name="Email" type="text" size="20" value="yourname@fda.moph.go.th" style=" font-size:14px; font-family:'Ms Sans Serif',Georgia, 'Times New Roman', Times, serif; color:#3300ff">
                      &nbsp;รหัสผ่าน :&nbsp;&nbsp;&nbsp;
                  ...
                  <tr>
                    ...
                    <dd style="font-size:14px; font-family:Arial, Helvetica, sans-serif">
                    1. กรณีที่ท่านลงทะเบียนแล้วต้องการเข้าใช้งานอย่างเร่งด่วน  กรุณาติดต่อ คุณเอ ที่เบอร์โทรศัพท์ 7254
                    <dd style="font-size:14px; font-family:Arial, Helvetica, sans-serif">
                    ...
                    <b>เปลี่ยนรหัสผ่าน</b>--></p>
                      ...
                      <table width="390" height="220" align="center" cellpadding="0" cellspacing="0" background="<%=path_link%>admin/image/bg_NewUser.gif" class="text1" style="background-repeat: no-repeat">
                        <tr> 
                          <td height="210" class="FontNorMal"> <table border="0" cellpadding="0" cellspacing="0" align=center width="90%" class="text3">
                              <tr> 
                              ...
                              <tr> 
                                ...
                                <td width="54%"> <input type="text" name="Lname"  size="20" class="FieldSkin" style="font-family: Ms sans serif; font-size: 8pt;"> 
                                </td>
                              </tr>
                              <tr> 
