...
dim Dateddmmyyyy
Dateddmmyyyy=Now()
getSOP_Code = Request.QueryString("hidMC")
...
<table width="70%" border="2" align="center" cellpadding="3" cellspacing="0">
  ...
  <%
		...
		if RecshowQS.RecordCount = 0 then
		response.write "<script language=""javascript""> "
		response.write "alert(""No Data in DB! \r\n Please try again!"");"
		response.write "window.location.href=""InternalAudit.asp""; "
